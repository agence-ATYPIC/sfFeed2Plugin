...
class sfAtom1Feed extends sfFeed
{
  ...
  public function toXml()
  {
    ...
    $xml[] = '  <link rel="alternate" href="'.$this->getLink().'"></link>';
    if ($this->getFeedUrl())
    {
      $xml[] = '  <link rel="self" href="'.$this->getFeedUrl().'"></link>';
    }
    $xml[] = '  <id>'.$this->getLink().'</id>';
    ...
    if ($this->getAuthorName())
    {
      ...
      {
        $xml[] = '    <uri>'.$this->getAuthorLink().'</uri>';
      }
      $xml[] = '  </author>';
    }
  ...
  private function getFeedElements()
  {
    ...
    foreach ($this->getItems() as $item)
    {
      ...
      $xml[] = '  <link rel="alternate" href="'.$item->getLink().'"></link>';
      if ($item->getPubdate())
      {
      ...
      if ($item->getAuthorName())
      {
        ...
        {
          $xml[] = '    <uri>'.$item->getAuthorLink().'</uri>';
        }
        $xml[] = '  </author>';
      }
